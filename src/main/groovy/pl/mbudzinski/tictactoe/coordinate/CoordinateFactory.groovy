...
class CoordinateFactory {
    ...
    public static final String SIGN_PROMPT = 'Where do you want to put your sign? (row, column)'
    ...
    Coordinate getCoordinateFromStdIn() {
        ...
        while (row < 0 || column < 0) {
            ...
            column = systemInReader.readInt(SIGN_PROMPT, INVALID_COORDINATES_ERROR, -1)
        }
